;;; frames-only-mode-autoloads.el --- automatically extracted autoloads
;;
;;; Code:
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "frames-only-mode" '("frames-only-mode-")))
